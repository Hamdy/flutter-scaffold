...
User _userDeserialize(
  ...
  final object = User(
    ...
    profileId: reader.readStringOrNull(offsets[4]),
    refreshToken: reader.readStringOrNull(offsets[5]),
    theme: _UserthemeValueEnumMap[reader.readStringOrNull(offsets[6])],
    type: _UsertypeValueEnumMap[reader.readStringOrNull(offsets[7])],
...
Device _deviceDeserialize(
  ...
  final object = Device(
    serial: reader.readString(offsets[0]),
    token: reader.readString(offsets[1]),
    type: _DevicetypeValueEnumMap[reader.readStringOrNull(offsets[2])] ??
        DeviceType.android,
  );
  object.id = id;
  return object;
